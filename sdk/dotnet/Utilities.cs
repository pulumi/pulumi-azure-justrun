...
namespace Pulumi.Azwebex
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Azwebex.version.txt");
    ...
    internal sealed class AzwebexResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AzwebexResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
