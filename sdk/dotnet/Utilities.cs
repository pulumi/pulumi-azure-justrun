...
namespace Pulumi.AzureJustrun
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AzureJustrun.version.txt");
    ...
    internal sealed class AzureJustrunResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AzureJustrunResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
