...
class WebappArgs:
    def __init__(__self__, *,
                 ...
                 container_public_access: Optional[pulumi.Input['_storage.PublicAccess']] = None,
    ...
    def container_public_access(self) -> Optional[pulumi.Input['_storage.PublicAccess']]:
        """
    ...
    def container_public_access(self, value: Optional[pulumi.Input['_storage.PublicAccess']]):
