...
test_go:: ./examples
	@export PATH
	cd examples/golangcontainerapp && go mod edit -replace github.com/pulumi/pulumi-azure-justrun/sdk@v0.2.0-beta-0=${WORKING_DIR}/sdk && go mod tidy
	cd examples/golangwebapp && go mod edit -replace github.com/pulumi/pulumi-azure-justrun/sdk@v0.2.0-beta-0=${WORKING_DIR}/sdk && go mod tidy
